...
class NhadatProperty(scrapy.Spider):
    ...
    def start_requests(self):
        # url = 'https://www.nhadat.net/102006520/book-nhanh-tay-vi-tri-van-phong-cho-cong-ty-tai-du-an-ascent-lakeside-q7'
    ...
    def parse(self, response):
        ...
        item['description']= translator.translate(strip_emoji(response.xpath('//div[@class="swptext"]/div/p/text()').extract()),dest='en')
